...
class MergedProductSchema(BaseModel):
    ...
    # --- New fields for All-Time Low price ---
...
def read_merged_products(
    ...
    """
    Retrieve a paginated list of merged products, including best price and all-time low data.
    """
    query = (
    ...
    for mp in results:
        ...
        # --- Best Current Price Calculation ---
        ...
        # --- All-Time Low Price Calculation ---
