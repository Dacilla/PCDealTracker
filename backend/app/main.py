...
from .api import deals, price_history, categories, retailers, merged_products, filters, trends
...
# app.include_router(products.router) # FIX: This line is removed as products.py no longer has a router
